...
<table class="products-table">
    <thead>
        <tr style="height: 50px"> 
            ...
            <th  align='center' rowspan='1' colspan='1' style='width:170px; min-width:170px; text-align:center'>DETAIL</th>
        </tr>
    </thead>
    <tbody id="table-body">
        <?php 
        ...
        <tr>
            ...
            <td style="text-align:center">
                <i onclick="editProductDetail(<?php echo $row['id']; ?>, <?php echo $_GET['page']; ?>)" id="edit" class="icon edit fa-solid fa-pen-to-square"></i>
            </td>
        </tr> 
        <?php
            }
